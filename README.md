...
![Saúde Ruim por Faixa Etária](imagens/saude_ruim.png)

### Colesterol Médio por Grupo
![Colesterol Médio](imagens/colesterol_medio.png)

### BMI por Gênero
![BMI por Gênero](imagens/bmi_por_genero.png)

### Relação entre Diabetes e BMI
![Diabetes por BMI](imagens/diabetes_por_bmi.png)

### Pressão Arterial por Faixa Etária
![Pressão por Faixa Etária](imagens/pressao_por_faixa_etaria.png)
